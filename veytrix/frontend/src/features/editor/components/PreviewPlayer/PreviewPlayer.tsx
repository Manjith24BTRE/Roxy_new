...
export function PreviewPlayer({
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#05070c] overflow-hidden select-none">
      {/* Visual Overlay Toggles */}
      <div className="h-10 border-b border-white/5 px-4 flex items-center justify-between bg-[#080b13] text-xs">
        <div className="flex items-center gap-3">
          <span className="text-[10px] font-bold text-slate-500 uppercase tracking-widest">Preview Window</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`p-1.5 rounded transition cursor-pointer flex items-center gap-1 border ${
              showGrid ? 'bg-sky-500/10 border-sky-400 text-sky-400 font-semibold' : 'bg-slate-900 border-white/5 text-slate-400 hover:text-slate-200'
            }`}
          ...
          <button
            ...
            className={`p-1.5 rounded transition cursor-pointer flex items-center gap-1 border ${
              showSafeZone ? 'bg-sky-500/10 border-sky-400 text-sky-400 font-semibold' : 'bg-slate-900 border-white/5 text-slate-400 hover:text-slate-200'
            }`}
          ...
          <div className="flex items-center gap-1.5 text-slate-400">
            ...
            <select
              ...
              className="rounded bg-slate-900 border border-white/5 text-[10px] px-1 py-0.5 cursor-pointer text-slate-300 focus:outline-none"
            >
      ...
      <div className="flex-1 p-4 flex flex-col items-center justify-center relative overflow-hidden" ref={containerRef}>
        <div
          className={`relative w-full rounded-xl border border-white/10 bg-black overflow-hidden shadow-2xl flex flex-col justify-between p-2 group transition-all duration-300 ${getAspectClass()}`}
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-slate-900 flex items-center justify-center pointer-events-none">
              ...
              />
              <div className="absolute top-2 left-2 bg-black/60 text-[8px] font-mono font-bold text-slate-400 px-1.5 py-0.5 rounded">
                BEFORE (RAW)
              </div>
            </div>
            ...
            >
              <div className="absolute inset-0 bg-slate-900 flex items-center justify-center">
                ...
                {activeEffectId === 'glitch-core' && (
                  <div className="absolute inset-0 bg-sky-500/5 mix-blend-color-dodge z-10 animate-[pulse_0.1s_infinite]" />
                )}
              ...
              <div className="absolute top-2 right-2 bg-sky-500/85 text-[8px] font-mono font-bold text-slate-950 px-1.5 py-0.5 rounded shadow-sm flex items-center gap-0.5">
            ...
            >
              <div className="h-8 w-5 rounded bg-slate-900 border border-white/20 text-white text-[8px] flex items-center justify-center shadow-lg font-bold">
                <Sliders className="h-3 w-3 text-slate-300" />
              </div>
            </div>

            {/* Grid overlay */}
            {showGrid && (
              <div className="absolute inset-0 grid grid-cols-3 grid-rows-3 pointer-events-none z-10 border border-white/5">
          ...
          {/* Time Code Overlay */}
          <div className="absolute bottom-2 left-2 z-10 font-mono text-[9px] text-slate-300 bg-black/60 rounded px-1.5 py-0.5">
      ...
      <div className="border-t border-white/5 bg-[#080b13] px-4 py-2 flex flex-col gap-2 flex-shrink-0">
        <div className="flex items-center gap-3">
          <input
            type="range"
            min="0"
        ...
        <div className="flex items-center justify-between text-xs text-slate-400 font-mono">
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-1 hover:text-white cursor-pointer transition"
              title="Step Backward"
            >
            ...
            <button
              ...
              className="h-7 w-7 rounded-md bg-white/10 hover:bg-white/20 text-white flex items-center justify-center transition cursor-pointer"
            >
