...
interface AuthContextValue {
  ...
  isSignedIn: boolean;
  isLoading: boolean;
  signInWithEmail: (email: str, password: str, rememberMe?: boolean) => Promise<void>;
  signUpWithEmail: (email: str, password: str, fullName: str) => Promise<SignUpResult>;
  signInWithGoogle: () => Promise<void>;
  signInAsDemo: () => Promise<void>;
  signOut: () => Promise<void>;
  resetPassword: (email: str) => Promise<void>;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const signInWithEmail = useCallback(async (email: str, password: str, rememberMe: boolean = true) => {
    setIsLoading(true);
    try {
  ...
  const signUpWithEmail = useCallback(async (email: str, password: str, fullName: str): Promise<SignUpResult> => {
    setIsLoading(true);
    try {
  ...
  const resetPassword = useCallback(async (email: str) => {
