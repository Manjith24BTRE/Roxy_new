...
import { HomeAnnouncementWidget } from './HomeAnnouncementWidget';
...
export function WelcomeHeader() {
  ...
  return (
    <div className="flex-shrink-0 py-4 md:py-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
      <div>
      ...
      {/* Real-time Broadcast Announcement Widget */}
