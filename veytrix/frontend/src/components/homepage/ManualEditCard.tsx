...
export function ManualEditCard() {
  return (
    <div className="h-full flex flex-col relative rounded-[20px] bg-gradient-to-br from-white to-[#E6F2F8] border border-[#1D2B64]/[0.08] shadow-[0_6px_24px_rgba(29,43,100,0.05)] overflow-hidden">
      ...
      <div className="absolute inset-x-0 bottom-0 top-1/2 opacity-30 pointer-events-none overflow-hidden">
        <div className="absolute top-10 left-0 right-0 h-px bg-[#1D2B64]/20" />
        <div className="absolute top-10 left-[30%] bottom-0 w-px bg-[#3B6CE7]" />
        
        {/* Playhead indicator */}
        <div className="absolute top-8 left-[30%] -translate-x-1/2 text-[8px] font-mono font-bold text-[#3B6CE7] bg-[#E6F2F8] px-1 rounded">
          PLAYHEAD
        </div>
      ...
      <div className="relative z-10 flex flex-col h-full p-6 lg:p-8">
        <div className="flex items-center gap-3 mb-4">
          <div className="w-10 h-10 rounded-xl bg-white border border-[#1D2B64]/10 flex items-center justify-center text-[#3B6CE7] shadow-sm">
            <Wand2 size={20} />
          </div>
          <h2 className="font-display text-2xl font-bold text-[#1D2B64] tracking-tight">AI Manual Edit</h2>
        </div>
        
        <p className="text-[#1D2B64]/70 text-sm md:text-base leading-relaxed max-w-sm mb-auto">
